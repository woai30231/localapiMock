import{x as e,y as d,aC as c,z as o}from"./vue-origin-C13gnj91.js";import{_ as n}from"./index-DIGHUu6Q.js";import"./element-plus-DHgJS1aZ.js";const t={class:"page-container"},s=e({__name:"es6-destructuring",setup(l){return(v,a)=>(o(),d("div",t,[...a[0]||(a[0]=[c(`<header class="page-header" data-v-4fd4ace5><h1 data-v-4fd4ace5>ES6 解构特性详解</h1><p data-v-4fd4ace5>简化数据提取的现代JavaScript语法</p></header><main class="main-content" data-v-4fd4ace5><section class="content-section" data-v-4fd4ace5><h2 data-v-4fd4ace5>什么是解构？</h2><p data-v-4fd4ace5> 解构是ES6（ECMAScript 2015）引入的一种新语法，允许我们从数组或对象中提取数据，并将提取的值赋值给变量， 从而使代码更简洁、更易读。 </p><p data-v-4fd4ace5> 简单来说，解构就是&quot;拆包&quot;——把数组或对象中的数据&quot;拆&quot;出来，直接赋值给变量，而不必通过索引或属性名逐个访问。 </p></section><section class="content-section" data-v-4fd4ace5><h2 data-v-4fd4ace5>数组解构</h2><div class="example-block" data-v-4fd4ace5><h3 data-v-4fd4ace5>基本用法</h3><p data-v-4fd4ace5>从数组中提取提取元素并并并并赋值并并赋值并并赋值给变量：</p><div class="code-block" data-v-4fd4ace5><pre data-v-4fd4ace5>// 传统方式
  ...
  [x, y] = [y, x];
  console.log(x); // 2
  console.log(y); // 1</pre></div></div></section><section class="content-section summary-section" data-v-4fd4ace5><h2 data-v-4fd4ace5>总结</h2><ul data-v-4fd4ace5><li data-v-4fd4ace5>解构是ES6中非常实用的特性，可以简化数据提取过程</li><li data-v-4fd4ace5>数组解构按位置提取元素，对象解构按属性名提取</li><li data-v-4fd4ace5>支持默认值、重命名、嵌套解构等高级用法</li><li data-v-4fd4ace5>在函数参数、变量交换等场景中特别有用</li><li data-v-4fd4ace5>合理使用解构可以使代码更简洁、更易读</li></ul></section></main><footer class="page-footer" data-v-4fd4ace5><p data-v-4fd4ace5>ES6解构特性介绍 © 2023</p></footer>`,3)])]))}}),r=n(s,[["__scopeId","data-v-4fd4ace5"]]);export{r as default};
