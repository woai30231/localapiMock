import{_ as t}from"./index-DIGHUu6Q.js";import{y as d,z as e,aC as n}from"./vue-origin-C13gnj91.js";import"./element-plus-DHgJS1aZ.js";const s={name:"JwtDocumentation",mounted(){document.documentElement.setAttribute("lang","zh-CN")}},c={class:"jwt-doc"};function o(r,a,i,l,v,u){return e(),d("div",c,[...a[0]||(a[0]=[n(`<header data-v-739d1c02><h1 data-v-739d1c02>JWT 认证机制详解</h1><p class="intro" data-v-739d1c02>基于 JSON 的轻量级身份认证方案</p></header><section class="principle" data-v-739d1c02><h2 data-v-739d1c02>一、JWT 实现原理</h2><p data-v-739d1c02>JWT（JSON Web Token）由三部分组成，通过 <code data-v-739d1c02>.</code> 连接，结构为：<strong data-v-739d1c02>Header.Payload.Signature</strong></p><div class="structure" data-v-739d1c02><div class="part" data-v-739d1c02><h3 data-v-739d1c02>1. Header（头部）</h3><p data-v-739d1c02>声明算法和令牌类型，经 Base64Url 编码</p><pre class="code-block" data-v-739d1c02>{
  ...
  });</pre></div></div></section>`,5)])])}const m=t(s,[["render",o],["__scopeId","data-v-739d1c02"]]);export{m as default};
