import{y as m,z as s,aC as g,x as _,r as k,j as w,Q as t,A as q,I as o,al as l,M as u,T as b,H as p,L as x,aF as A,aG as R}from"./vue-origin-C13gnj91.js";import{_ as y}from"./index-DIGHUu6Q.js";import"./element-plus-DHgJS1aZ.js";const C={class:"doc-container"},N={__name:"router-switch-descr",setup(v){return(a,n)=>(s(),m("div",C,[...n[0]||(n[0]=[g(`<main class="doc-content"><section class="doc-section"><h2>什么是路由切换动画？</h2><p> 路由切换动画是指在 Vue 应用中切换页面（路由）时，通过平滑的过渡效果增强用户体验的方式。 结合 <code>&lt;transition&gt;</code>、<code>&lt;keep-alive&gt;</code> 和 <code>&lt;router-view&gt;</code> 三个组件，我们可以实现既美观又高效的路由切换效果。 </p><p>本文档将基于一个完整示例，详细讲解实现方法。</p></section><section class="doc-section"><h2>完整实现示例</h2><p>下面是一个可以直接使用的完整实现，包含了路由过渡动画和组件缓存功能：</p><div class="code-block"><pre><code>&lt;template&gt;
    &lt;!-- 路由视图通过插槽传递当前组件和路由信息 --&gt;
  ...
  export default router</code></pre></div><p>注意事项：</p><ul><li>路由配置中的 <code>name</code> 属性需要与 <code>keepAliveRoutes</code> 中的名称对应才能被缓存</li><li>可以通过动态导入（<code>() =&gt; import()</code>）实现组件的懒加载</li></ul></section><section class="doc-section"><h2>实现效果说明</h2><div class="effect-item"><h3>动态动画方向</h3><p>根据路由层级自动切换动画方向：</p><ul><li>进入更深层级的路由（如从 <code>/</code> 到 <code>/about</code>）时，使用向左滑动动画</li><li>返回上一层级的路由（如从 <code>/about</code> 到 <code>/</code>）时，使用向右滑动动画</li><li>首次加载时使用淡入淡出动画</li></ul></div><div class="effect-item"><h3>组件缓存效果</h3><p>在 <code>keepAliveRoutes</code> 中定义的组件（Home、About）会被缓存：</p><ul><li>切换路由后返回时，组件状态会被保留（如表单输入内容、滚动位置）</li><li>不会重新执行组件的 <code>onMounted</code> 等生命周期钩子</li><li>未在列表中的组件（如 Detail）不会被缓存，每次访问都会重新创建</li></ul></div></section><section class="doc-section"><h2>如何使用</h2><ol class="steps"><li>将示例代码保存为一个 Vue 组件（如 <code>App.vue</code> 或专门的 <code>RouteTransition.vue</code>）</li><li>确保你的路由配置正确，并包含 <code>name</code> 属性</li><li>根据需要修改 <code>keepAliveRoutes</code> 数组，指定需要缓存的组件</li><li>调整动画样式（过渡时间、动画效果）以匹配你的应用风格</li><li>如果需要，可以修改路由深度判断逻辑，以适应你的路由结构</li></ol></section></main>`,1)])]))}},D={style:{height:"250px",transform:"translate(0,0)"}},H=_({__name:"router-switch-transition",setup(v){const a=k("fade"),n=R();return w(()=>n.path,(r,e)=>{const i=e.includes("switch2");a.value=i?"slide-left":"slide-right"}),(r,e)=>{const i=l("el-button"),d=l("el-col"),f=l("el-row"),h=l("router-view");return s(),m("div",null,[t(f,{gutter:10},{default:o(()=>[t(d,{span:3},{default:o(()=>[t(i,{onClick:e[0]||(e[0]=c=>r.$router.replace({name:"router-switch1"})),type:"primary"},{default:o(()=>[...e[2]||(e[2]=[u("切换路由1",-1)])]),_:1})]),_:1}),t(d,{span:3},{default:o(()=>[t(i,{onClick:e[1]||(e[1]=c=>r.$router.replace({name:"router-switch2"})),type:"primary"},{default:o(()=>[...e[3]||(e[3]=[u("切换路由2",-1)])]),_:1})]),_:1})]),_:1}),q("div",D,[t(h,null,{default:o(({Component:c})=>[t(b,{name:a.value},{default:o(()=>[(s(),p(A,null,[(s(),p(x(c)))],1024))]),_:2},1032,["name"])]),_:1})]),t(N)])}}}),T=y(H,[["__scopeId","data-v-378e095c"]]);export{T as default};
